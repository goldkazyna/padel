...
Route::prefix('mobile')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::post('/admin/tournaments/{tournament}/league/refill', [MobileAdminTournamentDetailController::class, 'refillFromLeague']);
        Route::delete('/admin/tournaments/{tournament}/rounds/{round}', [MobileAdminTournamentDetailController::class, 'removeRound']);
        ...
        Route::post('/admin/tournaments/{tournament}/teams/{team}/move', [MobileAdminTournamentDetailController::class, 'moveTeam']);
        ...
        // Открытые пары: занять пустую пару в сетке.
        Route::post('/tournaments/{tournament}/pairs', [MobileTournamentController::class, 'takeEmptyPair']);
        // Открытые пары: сесть в свободное место чужой пары.
        Route::post('/tournaments/{tournament}/pairs/{team}/join', [MobileTournamentController::class, 'joinPair']);
        ...
        Route::get('/courts/clubs/{club}/cards', [MobileCourtController::class, 'clubCards']);
