...
@if($ready)
    <div class="esc-note mb-4">
        ...
        Корты собраны равными по составу: на каждом сильный, слабый и двое из середины.
        Так стартовый корт никому не даёт форы. Игроки без рейтинга считаются самыми слабыми.
