            ...
            <thead>
                <tr>
                    ...
                    <th class="col-points ttt esc-main-col"
                        title="{{ $isRawMode ? 'Забитые очки плюс бонус за результат (победа +2, ничья +1) — по сумме зачёт' : 'Баллы за позиции в общем строю — по ним зачёт' }}">
                ...
                @foreach($standings as $row)
                    ...
                    <tr class="{{ $rankClass }}">
                        ...
                        <td class="col-points ttt esc-main-col">
                            ...
                            @if($isRawMode && $row['bonus_points'] > 0)
