...
class ContactHandle
{
    ...
    /**
     * Любой телефон в цифрах, включая иностранные.
     *
     * Казахстанские и российские приводим к 11 цифрам с семёркой: «8 707…»,
     * «+7 707…» и «707…» — один и тот же номер, иначе один человек заводится
     * дважды. Остальные страны оставляем как есть: у них своя длина, и
     * подгонять её под наш формат нельзя (Колумбия — 12 цифр, США — 11).
     */
    public static function anyPhone(?string $value): ?string
    {
        ...
        // Границы E.164: короче 10 цифр — точно опечатка, длиннее 15 не бывает.
