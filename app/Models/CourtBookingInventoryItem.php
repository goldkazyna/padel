...
/**
 * Позиция инвентаря, выданная по брони корта. Название и цена хранятся снимком
 * на момент первой выдачи и не следуют за справочником: позицию могли потом
 * переименовать, переоценить, выключить или удалить — выданное не меняется.
 */
