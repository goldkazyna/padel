...
class KingOfCourtMatch extends Model
{
    use HasFactory;

    protected $table = 'kingofcourt_matches';

    protected $fillable = [
        'kingofcourt_round_id',
        'court_number',
        'team1_player1_id',
        'team1_player2_id',
        'team2_player1_id',
    ...
    {
        return $this->belongsTo(KingOfCourtRound::class, 'kingofcourt_round_id');
    }
