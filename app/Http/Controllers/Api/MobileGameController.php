...
class MobileGameController extends Controller
{
    ...
    private function validateGame(Request $request): array
    {
        return $request->validate([
            ...
            // Восемь — потолок: на один корт больше не садится так, чтобы
            // человек успел сыграть. Готовая сетка Флекс есть ровно на 4–8.
            'capacity' => 'nullable|integer|min:4|max:8',
        ]);
    }
