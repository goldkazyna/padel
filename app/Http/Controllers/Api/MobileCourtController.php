...
class MobileCourtController extends Controller
{
    ...
    public function clubs(Request $request)
    {
        ...
        // Порядок: сначала клубы с ручной сортировкой (её задаёт супер-админ
        // в карточке клуба), затем остальные по дате добавления. Без явного
        // порядка база отдавала строки как придётся, и список «прыгал».
