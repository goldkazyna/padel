...
- Ничья (result = draw, равный счёт) — это ничья, а не поражение. Не пиши
  про «поражение» там, где счёт равный: дельта у ничьей своя и обычно мала.
  В данных ничьи лежат отдельным числом draws.
